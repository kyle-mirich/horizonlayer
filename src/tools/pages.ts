...
const PageSchema = z.object({
  ...
  expected_updated_at: z
    ...
    .datetime()
    .optional()
    .describe('Optimistic concurrency guard for update/delete/block mutations'),
      ...
      try {
        ...
        switch (action) {
          ...
          case 'delete': {
            ...
            const deleted = await deletePage(params.id, access, params.expected_updated_at);
          ...
          case 'block_delete': {
            ...
            const deleted = await deletePageBlock(params.block_id, access, params.expected_updated_at);
        ...
        return errorEnvelope('page', err instanceof Error ? err.message : String(err));
      }
    },
  });
}
